...
Lifted from the monolith's services/monolith/tests/unittests/test_budget_period.py
(retrieved from git history at commit 402f2173, before the monolith source was
removed in f67ffda4) and adapted to import from the shared `domain` package
instead of `backend.shared.budget_period`.
