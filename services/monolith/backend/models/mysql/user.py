...
from .common import Base, Column, DateTime, Integer, String, account_group_user_association, func, relationship
...
class User(Base):
    ...
    account_groups = relationship(
        ...
        secondaryjoin=lambda: (
            ...
            == Base.metadata.tables["AccountGroups"].c.idAccountGroups
        ),
        foreign_keys=[
