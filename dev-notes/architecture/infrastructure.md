...
- **Compose** (802 lines, primary dev runtime): redis, 8× postgres (one per service), rabbitmq, ollama (+ one-shot `ollama-pull`), 10 API services, 15 worker/consumer containers. Frontend NOT in compose (`make dev-frontend`).
