...
- [sessions/2026-07-28-p324-adr-perimeter.md](2026-07-28-p324-adr-perimeter.md) — P3-24's ADR-halvdel: ADR-0005 vælger nginx som perimeter, ikke gateway-service; spørgsmålet blev omformet af at k8s slet ikke har en indgang (30 ClusterIP, ingen Ingress) og `VITE_*` aldrig er sat — der er ingen deployment hvor en perimeter ville være nåelig.
