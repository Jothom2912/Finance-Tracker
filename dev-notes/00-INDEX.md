...
- [plans/2026-07-28-p343-nginx-perimeter.md](plans/2026-07-28-p343-nginx-perimeter.md) — P3-43: ADR-0005 sat i drift (ti eksplicitte proxy-locations, relative URLs, 11 × `CORSMiddleware` ud, drift-vagt som rule 5); sweepet fandt at der slet ikke findes en `frontend`-service i compose, så perimeteren i dag hverken kan køres eller bevises.
