...
- [sessions/2026-07-26-p320-cleanup-script-outbox.md](sessions/2026-07-26-p320-cleanup-script-outbox.md) — P3-20 shipped: ES juli 17.666,17 → 17.528,17 (= Postgres eksakt), 0 fantomer tilbage for rigtige brugere; fuld id-sæt-diff afslørede 66 eval-fixtures i produktions-indexet (→ P3-21) og korrigerede mit eget "kun én række".
