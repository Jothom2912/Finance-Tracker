...
| P3-16 | Goal delete vs allocation history: hard-delete on a goal with `goal_allocation_history` rows → FK violation → 500. Decide soft-delete (preferred, preserves audit trail) or 409-guard; ensure default-flag never points at a dead goal | goal | S | open | [findings/2026-07-17-goal-delete-fk-500.md](../findings/2026-07-17-goal-delete-fk-500.md) |
