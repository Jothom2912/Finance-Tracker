...
| TAX-14 | Explicit categorization direction | Direction is a required field in the categorize contract and the engine no longer infers it from a sign; all four producers derive it from `transaction_type` | TAX-06 | done 2026-08-03 — 54 of 529 legacy rows newly rule-matched — [plan + Outcome](../plans/2026-08-03-tax14-explicit-categorization-direction.md#outcome--implemented-2026-08-03) |
| TAX-15 | Re-derive reclassification evidence | With direction correct, 54 of the 529 legacy-referenced transactions become rule-matchable and the 527 unresolved need re-judging; requires a fresh dry run, new hashes and separate approval — TAX-10's approval does not cover them | TAX-14 | open — [TAX-14 Outcome](../plans/2026-08-03-tax14-explicit-categorization-direction.md#outcome--implemented-2026-08-03) |
| TAX-16 | One owner for the transaction category | Make the async consumer agree with `create_transaction`: an explicit caller category is authoritative and a fallback-tier result never overwrites it. Lets the budget E2E stop depending on global rule coverage | TAX-14 | open — [finding](../findings/2026-08-03-async-categorization-overwrites-caller-category.md) |
| TAX-12 | Merchant evidence on the import path | Carry bank `creditor_name`/`debtor_name` through the transaction event contract and schema as merchant/counterparty so the 42 `match_field='merchant'` rules become reachable; add a test that categorizes a realistic bank description end to end | TAX-06 | open — [finding](../findings/2026-08-03-taxonomy-activation-breaks-live-categorization.md) |
| TAX-13 | Honest unknown fallback | Add typed `Ukendt køb`/`Ukendt indbetaling` buckets additively and point the absolute fallback at the direction-appropriate one instead of `shopping_unspecified` | TAX-06, TAX-14 | plan awaiting approval — [plan](../plans/2026-08-03-tax13-honest-unknown-fallback.md) · [finding](../findings/2026-08-03-taxonomy-activation-breaks-live-categorization.md) |
