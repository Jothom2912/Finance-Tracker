...
| TAX-14 | Explicit categorization direction | Stop inferring direction from a sign transaction-service never sends; carry it in the categorize contract as a required field and test through the real client. Restores 33 of the 75 unreachable rules and re-derives the TAX-07 evidence | TAX-06 | plan awaiting approval — [plan](../plans/2026-08-03-tax14-explicit-categorization-direction.md) · [finding](../findings/2026-08-03-taxonomy-activation-breaks-live-categorization.md) |
