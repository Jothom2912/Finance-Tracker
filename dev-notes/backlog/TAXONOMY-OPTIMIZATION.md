...
| TAX-14 | Explicit categorization direction | Stop inferring direction from a sign transaction-service never sends; carry direction (or a `transaction_type`-derived signed amount) in the categorize contract and test through the real client. Restores 33 of the 75 unreachable rules | TAX-06 | open — [finding](../findings/2026-08-03-taxonomy-activation-breaks-live-categorization.md) |
