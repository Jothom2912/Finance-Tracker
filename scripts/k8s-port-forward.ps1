...
Start-Process powershell -ArgumentList "kubectl -n finance-tracker port-forward svc/monolith 8000:8000"
...
Write-Host "GraphQL:   http://localhost:8000/api/v1/graphql" -ForegroundColor Green
