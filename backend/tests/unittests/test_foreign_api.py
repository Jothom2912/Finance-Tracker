...
from backend.services.currency_service import convert_currency, get_rate


def test_get_latest_rate_mocked():
    mock_response = {"base": "EUR", "rates": {"USD": "1.08"}}
...
def test_convert_currency_mocked():
    mock_response = {"query": {"from": "USD", "to": "EUR", "amount": 100}, "result": "92.50"}
